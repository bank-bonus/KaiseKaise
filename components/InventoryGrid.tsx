    ...
    <div className="animate-fadeIn">
      ...
      {filteredInventory.length === 0 ? (
        <div className="bg-[#111827] rounded-3xl p-20 text-center border border-dashed border-gray-800">
          ...
          <h3 className="text-xl font-bold text-gray-600">No items found in this section</h3>
          <p className="text-gray-700">Open some cases to fill your storage!</p>
        </div>
      ) : (
            ...
            >
              <div className="p-4">
                <div className="flex justify-between items-start mb-4">
                  <span className="text-green-500 font-bold text-xs font-mono">${item.price.toFixed(2)}</span>
                  <button 
                    onClick={() => onSell(item)}
                ...
                <div className="text-center overflow-hidden">
                  <p className="text-[10px] text-gray-500 font-bold uppercase truncate">{item.weapon}</p>
