  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-[#05070a]/95 backdrop-blur-3xl animate-fadeIn">
      <div className="absolute top-12 left-1/2 -translate-x-1/2 text-center">
        <span className="text-yellow-500 font-black tracking-[0.5em] text-xs uppercase mb-2 block animate-pulse">УСПЕШНОЕ ПОЛУЧЕНИЕ</span>
        <h2 className="text-5xl font-black text-white italic tracking-tighter uppercase">НОВЫЙ АКТИВ</h2>
      </div>
          ...
          <div className="bg-white/5 p-8 rounded-3xl border border-white/10 backdrop-blur-md">
            ...
            <div className="space-y-6 mb-10">
              ...
              <div className="flex justify-between items-end border-t border-white/5 pt-6">
                <div>
                  <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Рыночная Оценка</p>
